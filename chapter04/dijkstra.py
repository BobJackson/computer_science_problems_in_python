...
from chapter04.mst import WeightedPath, print_weighted_path
from chapter04.priority_queue import PriorityQueue
from chapter04.weighted_edge import WeightedEdge
from chapter04.weighted_graph import WeightedGraph
...
def dijkstra(wg: WeightedGraph[V], root: V) -> Tuple[List[Optional[float]], Dict[int, WeightedEdge]]:
    ...
    pg: PriorityQueue[DijkstraNode] = PriorityQueue()
    pg.push(DijkstraNode(first, 0))
    ...
    while not pg.empty:
        ...
        for we in wg.edges_for_index(u):
            ...
            if dist_v is None or dist_v > we.weight + dist_u:
                ...
                path_dict[we.v] = we
                pg.push(DijkstraNode(we.v, we.weight + dist_u))
